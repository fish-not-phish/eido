...
1. Code your diagram using our DSL.
2. Press the save button and your DSL with be transformed into a diagram.
3. Re-arrange the nodes to your liking.
4. Press save again to save your re-arranged diagram.

> [!IMPORTANT]
>
> For groups, always click and drag the most parent group to ensure all children nodes move with it.

> [!CAUTION]
>
> Adding new nodes to your DSL will force our parser to re-compile your diagram. This means you will need to re-arrange your nodes again.
...
> [!IMPORTANT]
>
> Members must already have an account in your Eido application.  
